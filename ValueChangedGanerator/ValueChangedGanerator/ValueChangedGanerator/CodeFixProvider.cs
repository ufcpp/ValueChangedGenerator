...
using ValueChangedGanerator.DataModels;
...
namespace ValueChangedGanerator
{
    ...
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds => ImmutableArray.Create(ValueChangedGaneratorAnalyzer.DiagnosticId);
